...
- The original worktree state was recorded before isolated inline-API
  development and archived during final release cleanup; it is not required to
  build, test, or reproduce the public implementation.
